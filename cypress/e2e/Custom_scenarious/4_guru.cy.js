...
const PostmanPage = require ('../../pages/postman_page.js')
const global_data = require ('../../data/global_text.js')
...
describe('Testing guru website', () => {
    ...
    it('click on postman link from dropdownlist POM', () => {
        ...
        postmanpage.imagewithPostmanDetails( {timeout: 25000} ).should('be.visible')
    })
